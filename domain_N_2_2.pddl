...
(define (domain bus)
    ...
    (:action drive_p2_p5
        ...
        :effect (and
            (not (location ?c p2))
            (itinerary ?c p2 p5)
            (assign (car-distance ?c p5) (distance p2 p5))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p2_to_p5
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p5) 0)
            (itinerary ?c p2 p5)
    ...
    (:action drive_p5_p6
        ...
        :effect (and
            (not (location ?c p5))
            (itinerary ?c p5 p6)
            (assign (car-distance ?c p6) (distance p5 p6))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p5_to_p6
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p6) 0)
            (itinerary ?c p5 p6)
    ...
    (:action drive_p6_p7
        ...
        :effect (and
            (not (location ?c p6))
            (itinerary ?c p6 p7)
            (assign (car-distance ?c p7) (distance p6 p7))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p6_to_p7
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p7) 0)
            (itinerary ?c p6 p7)
    ...
    (:action drive_p7_p6
        ...
        :effect (and
            (not (location ?c p7))
            (itinerary ?c p7 p6)
            (assign (car-distance ?c p6) (distance p7 p6))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p7_to_p6
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p6) 0)
            (itinerary ?c p7 p6)
    ...
    (:action drive_p8_p14
        ...
        :effect (and
            (not (location ?c p8))
            (itinerary ?c p8 p14)
            (assign (car-distance ?c p14) (distance p8 p14))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p8_to_p14
        :parameters (?c -car)
        :precondition (and
        ...
        :effect (and
            (location ?c p14)
            (not (itinerary ?c p8 p14))
        )
    )

    (:action drive_p14_p13
        :parameters (?c -car)
        :precondition (and
            (location ?c p14)
            (>= (energy ?c) 6)
        ...
        :effect (and
            (not (location ?c p14))
            (itinerary ?c p14 p13)
            (assign (car-distance ?c p13) (distance p14 p13))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p14_to_p13
        :parameters (?c -car)
        :precondition (and
    ...
    (:action drive_p6_p12
        ...
        :effect (and
            (not (location ?c p6))
            (itinerary ?c p6 p12)
            (assign (car-distance ?c p12) (distance p6 p12))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p6_to_p12
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p12) 0)
            (itinerary ?c p6 p12)
        )
        :effect (and
            (location ?c p12)
            (not (itinerary ?c p6 p12))
        )
    )
    ...
    (:action drive_p12_p9
        ...
        :effect (and
            (not (location ?c p12))
            (itinerary ?c p12 p9)
            (assign (car-distance ?c p9) (distance p12 p9))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p12_to_p9
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p9) 0)
            (itinerary ?c p12 p9)
    ...
    (:action drive_p9_p10
        ...
        :effect (and
            (not (location ?c p9))
            (itinerary ?c p9 p10)
            (assign (car-distance ?c p10) (distance p9 p10))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p9_to_p10
        :parameters (?c -car)
        :precondition (and
        ...
        :effect (and
            (location ?c p10)
            (not (itinerary ?c p9 p10))
        )
    )

    (:action drive_p10_p11
        :parameters (?c -car)
        :precondition (and
            (location ?c p10)
            (>= (energy ?c) 4)
        ...
        :effect (and
            (not (location ?c p10))
            (itinerary ?c p10 p11)
            (assign (car-distance ?c p11) (distance p10 p11))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p10_to_p11
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p11) 0)
            (itinerary ?c p10 p11)
        )
        :effect (and
            (location ?c p11)
            (not (itinerary ?c p10 p11))
        )
    )
    (:action drive_p11_p9
        :parameters (?c -car)
        ...
        :effect (and
            (not (location ?c p11))
            (itinerary ?c p11 p9)
            (assign (car-distance ?c p9) (distance p11 p9))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p11_to_p9
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p9) 0)
            (itinerary ?c p11 p9)
    ...
    (:action drive_p9_p12
        ...
        :effect (and
            (not (location ?c p9))
            (itinerary ?c p9 p12)
            (assign (car-distance ?c p12) (distance p9 p12))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p9_to_p12
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p12) 0)
            (itinerary ?c p9 p12)
        ...
        :effect (and
            (location ?c p12)
            (not (itinerary ?c p9 p12))
        )
    )

    (:action drive_p12_p13
        :parameters (?c -car)
        :precondition (and
            (location ?c p12)
            (>= (energy ?c) 12)
            ;(not(off-loading ?c)) ;check this is it causes a problem later
        )
        :effect (and
            (not (location ?c p12))
            (itinerary ?c p12 p13)
            (assign (car-distance ?c p13) (distance p12 p13))
            (assign (speed ?c) (ave_speed))
        )
    )
    (:event arrived_from_p12_to_p13
        :parameters (?c -car)
        :precondition (and
            (<= (car-distance ?c p13) 0)
            (itinerary ?c p12 p13)
    ...
    (:action boarding_people_p5
        ...
        :precondition (and
            ...
            (> (people_requested_itinerary p5 p11) 0)
            (<= (people_in_car ?c) 30)
        )
        :effect (and
            (decrease
                (people_at_station p5)
                (people_requested_itinerary p5 p11)
                )
            (increase
                (people_in_car ?c)
                (people_requested_itinerary p5 p11)
                )
            (move_people p5 p11 ?c)
            (assign (speed ?c) 0)
            (loading ?c)
        )
    )
    ...
    (:action boarding_people_p6
        ...
        :precondition (and
            ...
            (> (people_requested_itinerary p6 p12) 0)
            (<= (people_in_car ?c) 30)
        )
        :effect (and
            (decrease
                (people_at_station p6)
                (people_requested_itinerary p6 p12)
                )
            (increase
                (people_in_car ?c)
                (people_requested_itinerary p6 p12)
                )
            (move_people p6 p12 ?c)
            (assign (speed ?c) 0)
            (loading ?c)
        )
    )
    (:process stop_proc_p6
        :parameters (?c -car)
        :precondition (and
            (location ?c p6)
    ...
    (:action boarding_people_p7
        :parameters (?c -car)
        :precondition (and
            (location ?c p7)
            (> (people_at_station p7) 0)
            (>= (max_arrival_time p7) (elapsed_time))
            (<= (min_arrival_time p7) (elapsed_time))
            (> (people_requested_itinerary p7 p12) 0)
            (<= (people_in_car ?c) 30)
        )
        :effect (and
            (decrease
                (people_at_station p7)
                (people_requested_itinerary p7 p12)
                )
            (increase
                (people_in_car ?c)
                (people_requested_itinerary p7 p12)
                )
            (move_people p7 p12 ?c)
            (assign (speed ?c) 0)
            (loading ?c)
        )
    )
    (:process stop_proc_p7
        :parameters (?c -car)
        :precondition (and
            (location ?c p7)
            (= (time_in_station ?c p7) 0)
            (= (speed ?c) 0)
            (loading ?c)
            (move_people p7 p12 ?c)
        )
        :effect (and
            (increase (time_in_station ?c p7) (* #t 1.0))
        )
    )
    (:event allow_depart_p7
        :parameters (?c -car)
        :precondition (and
            (location ?c p7)
            (= (speed ?c) 0)
            (move_people p7 p12 ?c)
            (>= (time_in_station ?c p7) 1)
            (loading ?c)
        )
        :effect (and
            (not(loading ?c))
            (assign (time_in_station ?c p7) 0)
        )
    )

    (:action boarding_people_p8
        :parameters (?c -car)
        :precondition (and
            (location ?c p8)
            (> (people_at_station p8) 0)
            (>= (max_arrival_time p8) (elapsed_time))
            (<= (min_arrival_time p8) (elapsed_time))
            (> (people_requested_itinerary p8 p14) 0)
            (<= (people_in_car ?c) 30)
        )
        :effect (and
            (decrease
                (people_at_station p8)
                (people_requested_itinerary p8 p14)
                )
            (increase
                (people_in_car ?c)
                (people_requested_itinerary p8 p14)
                )
            (move_people p8 p14 ?c)
            (assign (speed ?c) 0)
            (loading ?c)
        )
    )
    (:process stop_proc_p8
        :parameters (?c -car)
        :precondition (and
            (location ?c p8)
            (= (time_in_station ?c p8) 0)
            (= (speed ?c) 0)
            (loading ?c)
            (move_people p8 p14 ?c)
        )
        :effect (and
            (increase (time_in_station ?c p8) (* #t 1.0))
        )
    )
    (:event allow_depart_p8
        :parameters (?c -car)
        :precondition (and
            (location ?c p8)
            (= (speed ?c) 0)
            (move_people p8 p14 ?c)
            (>= (time_in_station ?c p8) 1)
            (loading ?c)
        )
        :effect (and
            (not(loading ?c))
            (assign (time_in_station ?c p8) 0)
        )
    )

    (:action boarding_people_p9
        :parameters (?c -car)
        :precondition (and
            (location ?c p9)
            (> (people_at_station p9) 0)
            (>= (max_arrival_time p9) (elapsed_time))
            (<= (min_arrival_time p9) (elapsed_time))
            (> (people_requested_itinerary p9 p13) 0)
            (<= (people_in_car ?c) 30)
        )
        :effect (and
            (decrease
                (people_at_station p9)
                (people_requested_itinerary p9 p13)
                )
            (increase
                (people_in_car ?c)
                (people_requested_itinerary p9 p13)
                )
            (move_people p9 p13 ?c)
            (assign (speed ?c) 0)
            (loading ?c)
        )
    )
    (:process stop_proc_p9
        :parameters (?c -car)
        :precondition (and
            (location ?c p9)
            (= (time_in_station ?c p9) 0)
            (= (speed ?c) 0)
            (loading ?c)
            (move_people p9 p13 ?c)
        )
        :effect (and
            (increase (time_in_station ?c p9) (* #t 1.0))
        )
    )
    (:event allow_depart_p9
        :parameters (?c -car)
        :precondition (and
            (location ?c p9)
            (= (speed ?c) 0)
            (move_people p9 p13 ?c)
            (>= (time_in_station ?c p9) 1)
            (loading ?c)
        )
        :effect (and
            (not(loading ?c))
            (assign (time_in_station ?c p9) 0)
        )
    )
    ...
    (:action off_boarding_people_p11_p5
        :parameters (?c -car)
        :precondition (and
            (location ?c p11)
            (>= (max_arrival_time p11) (elapsed_time))
            (<= (min_arrival_time p11) (elapsed_time))
            (>(people_requested_itinerary p5 p11) 0)
            (move_people p5 p11 ?c)
        )
        :effect (and
            (not (move_people p5 p11 ?c))
            (increase
                (people_at_station p11)
                (people_requested_itinerary p5 p11)
                )
            (decrease
                (people_in_car ?c)
    ...
    (:process stop_proc_p11_p5
        :parameters (?c -car)
        :precondition (and
            (location ?c p11)
            (= (time_in_station ?c p11) 0)
            (= (speed ?c) 0)
            (off-loading ?c)
            (not (move_people p5 p11 ?c))
        )
        :effect (and
            (increase (time_in_station ?c p11) (* #t 1.0))
        )
    )
    (:event allow_depart_p11_p5
        :parameters (?c -car)
        :precondition (and
            (location ?c p11)
            (= (speed ?c) 0)
            (not (move_people p5 p11 ?c))
            (>= (time_in_station ?c p11) 1)
            (off-loading ?c)
        )
        :effect (and
            (not(off-loading ?c))
            (assign (time_in_station ?c p11) 0)
        )
    )

    (:action off_boarding_people_p12_p6
        :parameters (?c -car)
        :precondition (and
            (location ?c p12)
            (>= (max_arrival_time p12) (elapsed_time))
            (<= (min_arrival_time p12) (elapsed_time))
            (>(people_requested_itinerary p6 p12) 0)
            (move_people p6 p12 ?c)
        )
        :effect (and
            (not (move_people p6 p12 ?c))
            (increase
                (people_at_station p12)
                (people_requested_itinerary p6 p12)
                )
            (decrease
                (people_in_car ?c)
    ...
    (:process stop_proc_p12_p6
        :parameters (?c -car)
        :precondition (and
            (location ?c p12)
            (= (time_in_station ?c p12) 0)
            (= (speed ?c) 0)
            (off-loading ?c)
            (not (move_people p6 p12 ?c))
        )
        :effect (and
            (increase (time_in_station ?c p12) (* #t 1.0))
        )
    )
    (:event allow_depart_p12_p6
        :parameters (?c -car)
        :precondition (and
            (location ?c p12)
            (= (speed ?c) 0)
            (not (move_people p6 p12 ?c))
            (>= (time_in_station ?c p12) 1)
            (off-loading ?c)
        )
        :effect (and
            (not(off-loading ?c))
            (assign (time_in_station ?c p12) 0)
        )
    )

    (:action off_boarding_people_p12_p7
        :parameters (?c -car)
        :precondition (and
            (location ?c p12)
            (>= (max_arrival_time p12) (elapsed_time))
    ...
    (:action off_boarding_people_p13_p9
        :parameters (?c -car)
        :precondition (and
            (location ?c p13)
            (>= (max_arrival_time p13) (elapsed_time))
    ...
    (:action off_boarding_people_p14_p8
        :parameters (?c -car)
        :precondition (and
            (location ?c p14)
            (>= (max_arrival_time p14) (elapsed_time))
...
; TODO 
;; ALIAS on zsh java -jar enhsp.jar -o dissertation-tracked/MACB-ITSC25/domain_N_2_2.pddl -f dissertation-tracked/MACB-ITSC25/instance_N_2_2.pddl